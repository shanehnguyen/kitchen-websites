const m="kw_pulse_token",o=e=>document.querySelector(e),i=o("[data-pl-gate]"),g=o("[data-pl-gate-err]"),p=o("[data-pl-body]"),d=o("[data-pl-note]"),T=o("[data-pl-funnel]"),$=o("[data-pl-list]"),k=o("[data-pl-updated]"),L=o("[data-pl-count]"),M=o("[data-pl-window]"),u=o("[data-pl-signout]"),y={landed:"cool",started:"cool",contact:"mid",details:"mid",obstacle:"warm",submitted:"good",booked:"good"},s=e=>(e||"").replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t]);function _(e){const t=Math.max(0,Math.round((Date.now()-e)/1e3));if(t<60)return`${t}s ago`;const n=Math.round(t/60);if(n<60)return`${n}m ago`;const a=Math.round(n/60);return a<24?`${a}h ago`:`${Math.round(a/24)}d ago`}function S(e){const t=Math.max(0,Math.round(((e.updatedAt||0)-(e.landedAt||0))/1e3));return t<60?`${t}s`:`${Math.round(t/60)}m`}function A(){try{return localStorage.getItem(m)||""}catch{return""}}function h(e){try{e?localStorage.setItem(m,e):localStorage.removeItem(m)}catch{}}function v(e){i.hidden=!1,p.hidden=!0,u.hidden=!0,e&&(g.textContent=e,g.hidden=!1)}function x(e){const t=e.length?e[0].count:0;T.innerHTML=e.map((n,a)=>{const r=a>0?e[a-1].count:n.count,c=t?Math.round(n.count/t*100):0,l=r-n.count,w=r?Math.round(l/r*100):0,E=y[n.stage]||"cool";return`
        <div class="pl-frow">
          <div class="pl-fmeta">
